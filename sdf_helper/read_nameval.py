...
def read_deck_file_all(dir='', pref='', file='deck.status'):
  #pref is a prefix, for instance './Data_run1/prefix_deck.status'
  #This will try and extract all the things mentioned, including those that are strings
  #Duplicates are now possible (because of context) so we add a running counter if required
